export const dreamersAbi = [
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'numberOfTokens', type: 'uint256' },
      {
        ...
        internalType: 'struct mirageDreamers.Coupon',
        name: 'coupon',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'contract mirageContracts', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'enum mirageDreamers.salePhase',
        name: '',
        type: 'uint8',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256[]', name: 'numHeld', type: 'uint256[]' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_maxMember', type: 'uint256' },
      { internalType: 'uint256', name: '_maxHolder', type: 'uint256' },
      { internalType: 'uint256', name: '_maxPartner', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_holder', type: 'uint256' },
      { internalType: 'uint256', name: '_member', type: 'uint256' },
    ],
    name: 'updateMintPrices',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'address', name: 'secondaryPayee', type: 'address' },
    ],
    name: 'withdraw',
    outputs: [],
    stateMutability: 'nonpayable',
